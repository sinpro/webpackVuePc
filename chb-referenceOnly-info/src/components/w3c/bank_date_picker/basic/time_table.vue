    ...
    <template v-if="!arrowControl">
      ...
      >
        <li
          ...
          @keydown.enter="
            handleClick('hours', { value: hour, disabled: disabled })
          "
      ...
      >
        <li
          ...
          @keydown.enter="
            handleClick('minutes', { value: key, disabled: false })
          "
      ...
      >
        <li
          ...
          @keydown.enter="
            handleClick('seconds', { value: key, disabled: false })
          "
...
import {
  ...
  getRangeMinutes,
  modifyTime
} from 'element-ui/lib/utils/date-util';
