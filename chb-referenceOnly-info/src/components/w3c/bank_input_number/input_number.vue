<template>
  <div
    ...
    :style="{ '--myInputWidth': myInputWidth + 'px' }"
  >
    <span class="labels_wrap">
...
<script>
import bankInput from '../bank_input/input';
...
export default {
  ...
  computed: {
    ...
    inAriaLabel() {
      return i18n.t('common.INCREASE');
    },
    deAriaLabel() {
      return i18n.t('common.DECREASE');
    }
  },
  methods: {
...
.input_wraps {
  ...
  /deep/ .el-input__inner {
    //  width: var(--myInputWidth) !important;
  }
}
